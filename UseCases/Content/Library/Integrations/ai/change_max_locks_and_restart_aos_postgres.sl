namespace: ai
flow:
  name: change_max_locks_and_restart_aos_postgres
  workflow:
    - modify_postgres_config:
        do:
          io.cloudslang.base.powershell.powershell_script:
            ...
            - port: '5985'
            - protocol: http
            - username: administrator # AOS Postgres Windows Server Username
            - password:
                value: '*9SG4-YBv&ANu%F?5%BlQszZ=ZX703nV' # AOS Postgres Windows Server Password
                sensitive: true
            - auth_type: basic
            - script: |
