namespace: ai
flow:
  name: configure_and_restart_postgres_aos_set_max_locks_40
  workflow:
    - modify_postgres_config_aos:
        do:
          io.cloudslang.base.powershell.powershell_script:
            ...
            - auth_type: basic
            - script: |
                $configFile = "C:\Program Files\PostgreSQL\12\data\postgresql.conf" # AOS Postgres data directory + \data\postgresql.conf
