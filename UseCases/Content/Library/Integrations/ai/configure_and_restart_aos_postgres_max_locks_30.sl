namespace: ai
flow:
  name: configure_and_restart_aos_postgres_max_locks_30
  workflow:
    - modify_postgres_config:
        do:
          io.cloudslang.base.powershell.powershell_script:
            ...
            - auth_type: basic
            - script: |
                $dataDir = "C:\Program Files\PostgreSQL\12" # AOS Postgres data directory
                $configFile = Join-Path -Path $dataDir -ChildPath "postgresql.conf"
